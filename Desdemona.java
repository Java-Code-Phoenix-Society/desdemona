package com.huffmancoding.desdemona;
...
public class Desdemona
{
    ...
    implements MouseListener
    {
        ...
        /**
         * Starts a human's turn by hilighting playable squares and turning on
         * the mouse listener.
         *
        ...
        {
            itsPossibleMoves = new ArrayList<SquareView>();
        ...
        /**
         * Turns on hilighting as the mouse enters the playable squarce.
         *
        ...
        {
            ((SquareView)e.getComponent()).hilight();
        }

        /**
         * Turns off hilighting as the mouse exits the playable squarce.
         *
    ...
    extends Player
    {
        ...
        /** How deep the computer wants us to think
         */
        private LinkedList<Board> itsFreeBoards = new LinkedList<Board>();
    ...
    public class Square
    {
        ...
        /**
         * Returns the player who's piece is currently occupying this square.
         *
        ...
        /** the player whos piece is this square
         */
    ...
    public class Board
    {
         ...
         */
        private int flipCountInDirection(
            Player p,
            int x,
            int y,
            int xDelta,
         ...
         */
        private Square[][] itsSquares = new Square[BOARD_SIZE][BOARD_SIZE];
    }

    /**
     * This class will display a square.  It listens to the property changes
     * of a square and responds to anyone who wants to hilight it.
     */
    ...
    extends JFrame
    {
        ...
        {
            return (SquareView)itsBoardPanel.getComponent(
                s.getY() * BOARD_SIZE + s.getX());
        }

        /** the board for playing
         */
        private Board itsBoard = new Board();

        /** panel containing the SquareViews
         */
        private JPanel itsBoardPanel =
            new JPanel(new GridLayout(BOARD_SIZE, BOARD_SIZE));

        /** the slider for controling the level
         */
        private JSlider itsLevelSlider = new JSlider(1, 10, 3);

        /** the status text label
         */
        private JLabel itsStatus = new JLabel(" ");
    }
     ...
     */
    private BoardView itsBoardView;
